...
var Swill = (() => {
  ...
  __export(index_exports, {
    ...
    TextField: () => TextField,
    View: () => View,
    _setFirstResponder: () => _setFirstResponder,
    activate: () => activate,
    appearViewTree: () => appearViewTree,
    attachController: () => attachController,
    attr: () => attr,
    attrDescriptorsOf: () => attrDescriptorsOf,
    bind: () => bind,
    binding: () => binding,
    chainTopResponder: () => chainTopResponder,
    codecFor: () => codecFor,
    ...
    deleteOne: () => deleteOne,
    detachViewTree: () => detachViewTree,
    el: () => el,
    fetchAll: () => fetchAll,
    fetchAllFrom: () => fetchAllFrom,
    fetchOne: () => fetchOne,
    fetchOneFrom: () => fetchOneFrom,
    finishControllerLoading: () => finishControllerLoading,
    firstResponderFor: () => firstResponderFor,
    getTransformer: () => getTransformer,
    hasMany: () => hasMany,
    hasOne: () => hasOne,
    htmlAttribute: () => htmlAttribute,
    installDefaultCodec: () => installDefaultCodec,
    isOptionalOutlet: () => isOptionalOutlet,
    jsonApiCodec: () => jsonApiCodec2,
    loadViewTree: () => loadViewTree,
    lookupModelType: () => lookupModelType,
    makeFirstResponder: () => makeFirstResponder,
    markDetached: () => markDetached,
    modelStoreFor: () => modelStoreFor,
    observable: () => observable,
    observePath: () => observePath,
    outlet: () => outlet,
    outletNamesOf: () => outletNamesOf,
    parseJsonApi: () => parseJsonApi,
    plainJsonCodec: () => plainJsonCodec,
    readPath: () => readPath,
    register: () => register,
    ...
    responderElement: () => responderElement,
    selectedObjectIdBinding: () => selectedObjectIdBinding,
    serializeModel: () => serializeModel,
    setActivationWiring: () => setActivationWiring,
    setChainTop: () => setChainTop,
    syncFirstResponderFromFocus: () => syncFirstResponderFromFocus,
    topViewsIn: () => topViewsIn,
    unbind: () => unbind,
    unbindAll: () => unbindAll,
    updateOne: () => updateOne,
    version: () => version,
  ...
  async function fetchAll(cls, params = new URLSearchParams()) {
