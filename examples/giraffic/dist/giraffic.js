...
var computedState = /* @__PURE__ */ new WeakMap();
function computedSlotFor(obj, name) {
  let perInstance = computedState.get(obj);
  if (!perInstance) {
    perInstance = /* @__PURE__ */ new Map();
    computedState.set(obj, perInstance);
  }
  let slot = perInstance.get(name);
  if (!slot) {
    slot = { installed: false, cached: void 0 };
    perInstance.set(name, slot);
  }
  return slot;
}
function computed(dependencies) {
  return function(originalGetter, context) {
    const name = String(context.name);
    const callbackName = `${name}DidChange`;
    return function() {
      ...
      if (!slot.installed) {
        ...
        for (const dep of dependencies) {
          ...
          if (first == null || !(first in this)) {
            console.error(
              `[computed] ${this.constructor.name}.${name}: unknown dependency \`${first}\` (path "${dep}") - typo or missing observable?`
            );
            continue;
          }
...
function ensureOwnRelationshipMap(meta) {
...
function decorateRelationship(kind, options) {
  return function(target, context) {
    const name = String(context.name);
    const callbackName = `${name}DidChange`;
    ...
    ensureOwnRelationshipMap(metaFor2(context)).set(name, {
      name,
    ...
    const loadingFor = (instance) => loading.has(instance);
    const setLoading = (instance, next) => {
      const prev = loadingFor(instance);
      if (prev === next) return;
      if (next) loading.add(instance);
      else loading.delete(instance);
      const cb = instance[loadingCallbackName];
      if (typeof cb === "function") cb.call(instance, prev, next);
    };
    const load = async (instance, reload) => {
      ...
      try {
        return kind === "hasOne" ? await instance.loadHasOne(name, { reload }) : await instance.loadHasMany(name, { reload });
      } finally {
    ...
    return {
      get() {
        ...
        if (this.id != null && !this.hasLoadedRelationship(name) && !loadingFor(this)) {
...
async function requestFormJson(method, url, body) {
...
// examples/giraffic/controllers/giraffic_menubar.ts
var _GirafficMenubar_decorators, _init9, _a9;
_GirafficMenubar_decorators = [register];
var GirafficMenubar = class extends (_a9 = Controller) {
  showLists() {
...
GirafficMenubar = __decorateElement(_init9, 0, "GirafficMenubar", _GirafficMenubar_decorators, GirafficMenubar);
__runInitializers(_init9, 1, GirafficMenubar);

// examples/giraffic/models/mailing_address.ts
var _country_dec, _postalCode_dec, _state_dec, _city_dec, _address2_dec, _address1_dec, _a10, _MailingAddress_decorators, _init10, _address1, _address2, _city, _state, _postalCode, _country;
_MailingAddress_decorators = [register];
var MailingAddress = class extends (_a10 = Model, _address1_dec = [attr({ key: "address_1" })], _address2_dec = [attr({ key: "address_2" })], _city_dec = [attr], _state_dec = [attr], _postalCode_dec = [attr({ key: "postal_code" })], _country_dec = [attr], _a10) {
  constructor() {
    super(...arguments);
    __privateAdd(this, _address1, __runInitializers(_init10, 8, this, "")), __runInitializers(_init10, 11, this);
    __privateAdd(this, _address2, __runInitializers(_init10, 12, this, "")), __runInitializers(_init10, 15, this);
    __privateAdd(this, _city, __runInitializers(_init10, 16, this, "")), __runInitializers(_init10, 19, this);
    __privateAdd(this, _state, __runInitializers(_init10, 20, this, "")), __runInitializers(_init10, 23, this);
    __privateAdd(this, _postalCode, __runInitializers(_init10, 24, this, "")), __runInitializers(_init10, 27, this);
    __privateAdd(this, _country, __runInitializers(_init10, 28, this, "")), __runInitializers(_init10, 31, this);
  }
};
...
__decorateElement(_init10, 4, "address1", _address1_dec, MailingAddress, _address1);
__decorateElement(_init10, 4, "address2", _address2_dec, MailingAddress, _address2);
__decorateElement(_init10, 4, "city", _city_dec, MailingAddress, _city);
__decorateElement(_init10, 4, "state", _state_dec, MailingAddress, _state);
__decorateElement(_init10, 4, "postalCode", _postalCode_dec, MailingAddress, _postalCode);
__decorateElement(_init10, 4, "country", _country_dec, MailingAddress, _country);
MailingAddress = __decorateElement(_init10, 0, "MailingAddress", _MailingAddress_decorators, MailingAddress);
__publicField(MailingAddress, "type", "mailing_address");
__publicField(MailingAddress, "url", "/api/mailing_addresses");
__runInitializers(_init10, 1, MailingAddress);

// examples/giraffic/models/member.ts
var _mailingAddress_dec, _robodialOptOut_dec, _photoUrl_dec, _phoneNumber_dec, _phoneCountryCode_dec, _phoneVisibility_dec, _phone_dec, _venmoHandle_dec, _tier_dec, _points_dec, _nickname_dec, _name_dec, _email_dec, _a11, _Member_decorators, _init11, _email, _name, _nickname, _points, _tier, _venmoHandle, _phone, _phoneVisibility, _phoneCountryCode, _phoneNumber, _photoUrl, _robodialOptOut, _mailingAddress;
_Member_decorators = [register];
var _Member = class _Member extends (_a11 = Model, _email_dec = [attr], _name_dec = [attr], _nickname_dec = [attr], _points_dec = [attr], _tier_dec = [attr], _venmoHandle_dec = [attr({ key: "venmo_handle" })], _phone_dec = [attr], _phoneVisibility_dec = [attr({ key: "phone_visibility" })], _phoneCountryCode_dec = [attr({ key: "phone_country_code" })], _phoneNumber_dec = [attr({ key: "phone_number" })], _photoUrl_dec = [attr({ key: "photo_url" })], _robodialOptOut_dec = [attr({ key: "robodial_opt_out" })], _mailingAddress_dec = [hasOne({
  key: "mailing_address",
  type: () => MailingAddress,
  url(member) {
  ...
  constructor() {
    super(...arguments);
    __privateAdd(this, _email, __runInitializers(_init11, 8, this, "")), __runInitializers(_init11, 11, this);
    __privateAdd(this, _name, __runInitializers(_init11, 12, this, "")), __runInitializers(_init11, 15, this);
    __privateAdd(this, _nickname, __runInitializers(_init11, 16, this, "")), __runInitializers(_init11, 19, this);
    __privateAdd(this, _points, __runInitializers(_init11, 20, this, 0)), __runInitializers(_init11, 23, this);
    __privateAdd(this, _tier, __runInitializers(_init11, 24, this, "")), __runInitializers(_init11, 27, this);
    __privateAdd(this, _venmoHandle, __runInitializers(_init11, 28, this, null)), __runInitializers(_init11, 31, this);
    __privateAdd(this, _phone, __runInitializers(_init11, 32, this, "")), __runInitializers(_init11, 35, this);
    __privateAdd(this, _phoneVisibility, __runInitializers(_init11, 36, this, "")), __runInitializers(_init11, 39, this);
    __privateAdd(this, _phoneCountryCode, __runInitializers(_init11, 40, this, "")), __runInitializers(_init11, 43, this);
    __privateAdd(this, _phoneNumber, __runInitializers(_init11, 44, this, "")), __runInitializers(_init11, 47, this);
    __privateAdd(this, _photoUrl, __runInitializers(_init11, 48, this, "")), __runInitializers(_init11, 51, this);
    __privateAdd(this, _robodialOptOut, __runInitializers(_init11, 52, this, false)), __runInitializers(_init11, 55, this);
    __privateAdd(this, _mailingAddress, __runInitializers(_init11, 56, this, null)), __runInitializers(_init11, 59, this);
  }
  static async me() {
    const doc = await requestJson("GET", "/api/me");
    const member = parseJsonApi(_Member, doc);
...
_email = new WeakMap();
_name = new WeakMap();
_nickname = new WeakMap();
_points = new WeakMap();
_tier = new WeakMap();
_venmoHandle = new WeakMap();
_phone = new WeakMap();
_phoneVisibility = new WeakMap();
_phoneCountryCode = new WeakMap();
_phoneNumber = new WeakMap();
_photoUrl = new WeakMap();
_robodialOptOut = new WeakMap();
_mailingAddress = new WeakMap();
__decorateElement(_init11, 4, "email", _email_dec, _Member, _email);
__decorateElement(_init11, 4, "name", _name_dec, _Member, _name);
__decorateElement(_init11, 4, "nickname", _nickname_dec, _Member, _nickname);
__decorateElement(_init11, 4, "points", _points_dec, _Member, _points);
__decorateElement(_init11, 4, "tier", _tier_dec, _Member, _tier);
__decorateElement(_init11, 4, "venmoHandle", _venmoHandle_dec, _Member, _venmoHandle);
__decorateElement(_init11, 4, "phone", _phone_dec, _Member, _phone);
__decorateElement(_init11, 4, "phoneVisibility", _phoneVisibility_dec, _Member, _phoneVisibility);
__decorateElement(_init11, 4, "phoneCountryCode", _phoneCountryCode_dec, _Member, _phoneCountryCode);
__decorateElement(_init11, 4, "phoneNumber", _phoneNumber_dec, _Member, _phoneNumber);
__decorateElement(_init11, 4, "photoUrl", _photoUrl_dec, _Member, _photoUrl);
__decorateElement(_init11, 4, "robodialOptOut", _robodialOptOut_dec, _Member, _robodialOptOut);
__decorateElement(_init11, 4, "mailingAddress", _mailingAddress_dec, _Member, _mailingAddress);
_Member = __decorateElement(_init11, 0, "Member", _Member_decorators, _Member);
__publicField(_Member, "type", "member");
__publicField(_Member, "url", "/api/members");
__runInitializers(_init11, 1, _Member);
var Member = _Member;

// examples/giraffic/models/mailing_list.ts
var _members_dec, _webhookUrl_dec, _historyEnabled_dec, _open_dec, _hidden_dec, _notificationsEnabled_dec, _address_dec, _description_dec, _name_dec2, _a12, _MailingList_decorators, _init12, _name2, _description, _address, _notificationsEnabled, _hidden, _open, _historyEnabled, _webhookUrl, _members;
_MailingList_decorators = [register];
var MailingList = class extends (_a12 = Model, _name_dec2 = [attr], _description_dec = [attr], _address_dec = [attr], _notificationsEnabled_dec = [attr({ key: "notifications_enabled" })], _hidden_dec = [attr], _open_dec = [attr], _historyEnabled_dec = [attr({ key: "history_enabled" })], _webhookUrl_dec = [attr({ key: "webhook_url" })], _members_dec = [hasMany({
  type: () => Member,
  url(list) {
  ...
  constructor(name, description, members) {
    super();
    __privateAdd(this, _name2, __runInitializers(_init12, 8, this, "")), __runInitializers(_init12, 11, this);
    __privateAdd(this, _description, __runInitializers(_init12, 12, this, "")), __runInitializers(_init12, 15, this);
    __privateAdd(this, _address, __runInitializers(_init12, 16, this, "")), __runInitializers(_init12, 19, this);
    __privateAdd(this, _notificationsEnabled, __runInitializers(_init12, 20, this, false)), __runInitializers(_init12, 23, this);
    __privateAdd(this, _hidden, __runInitializers(_init12, 24, this, false)), __runInitializers(_init12, 27, this);
    __privateAdd(this, _open, __runInitializers(_init12, 28, this, false)), __runInitializers(_init12, 31, this);
    __privateAdd(this, _historyEnabled, __runInitializers(_init12, 32, this, false)), __runInitializers(_init12, 35, this);
    __privateAdd(this, _webhookUrl, __runInitializers(_init12, 36, this, "")), __runInitializers(_init12, 39, this);
    __privateAdd(this, _members, __runInitializers(_init12, 40, this, [])), __runInitializers(_init12, 43, this);
    if (name !== void 0) this.name = name;
    if (description !== void 0) this.description = description;
    if (members !== void 0) this.members = members;
  }
  async searchMemberCandidates(query, limit = 10) {
  ...
  async addMember(candidate) {
    if (this.id == null) throw new Error("Cannot add a member before the list is saved");
    const body = candidate instanceof Member && candidate.id != null ? { member_id: candidate.id } : { email: candidate instanceof Member ? candidate.email : candidate };
...
_notificationsEnabled = new WeakMap();
_hidden = new WeakMap();
_open = new WeakMap();
_historyEnabled = new WeakMap();
_webhookUrl = new WeakMap();
_members = new WeakMap();
__decorateElement(_init12, 4, "name", _name_dec2, MailingList, _name2);
__decorateElement(_init12, 4, "description", _description_dec, MailingList, _description);
__decorateElement(_init12, 4, "address", _address_dec, MailingList, _address);
__decorateElement(_init12, 4, "notificationsEnabled", _notificationsEnabled_dec, MailingList, _notificationsEnabled);
__decorateElement(_init12, 4, "hidden", _hidden_dec, MailingList, _hidden);
__decorateElement(_init12, 4, "open", _open_dec, MailingList, _open);
__decorateElement(_init12, 4, "historyEnabled", _historyEnabled_dec, MailingList, _historyEnabled);
__decorateElement(_init12, 4, "webhookUrl", _webhookUrl_dec, MailingList, _webhookUrl);
__decorateElement(_init12, 4, "members", _members_dec, MailingList, _members);
MailingList = __decorateElement(_init12, 0, "MailingList", _MailingList_decorators, MailingList);
__publicField(MailingList, "type", "list");
__publicField(MailingList, "url", "/api/lists");
__runInitializers(_init12, 1, MailingList);
...
// examples/giraffic/controllers/mailing_list.ts
var _members_dec2, _membersList_dec, _a13, _MembersApp_decorators, _init13, _members2;
_MembersApp_decorators = [register];
var MembersApp = class extends (_a13 = Controller, _membersList_dec = [outlet], _members_dec2 = [observable], _a13) {
  constructor() {
    super(...arguments);
    __publicField(this, "membersList", __runInitializers(_init13, 12, this)), __runInitializers(_init13, 15, this);
    __privateAdd(this, _members2, __runInitializers(_init13, 8, this, [])), __runInitializers(_init13, 11, this);
  }
  awakeFromDOM() {
...
_members2 = new WeakMap();
__decorateElement(_init13, 4, "members", _members_dec2, MembersApp, _members2);
__decorateElement(_init13, 5, "membersList", _membersList_dec, MembersApp);
MembersApp = __decorateElement(_init13, 0, "MembersApp", _MembersApp_decorators, MembersApp);
__runInitializers(_init13, 1, MembersApp);
var _profileActionsDisabled_dec, _saveError_dec, _isSaving_dec, _draftMember_dec, _member_dec, _phoneVisibilitySelect_dec, _a14, _MeProfileApp_decorators, _init14, _member, _draftMember, _isSaving, _saveError;
_MeProfileApp_decorators = [register];
var MeProfileApp = class extends (_a14 = Controller, _phoneVisibilitySelect_dec = [outlet], _member_dec = [observable], _draftMember_dec = [observable], _isSaving_dec = [observable], _saveError_dec = [observable], _profileActionsDisabled_dec = [computed([
  "draftMember",
  "draftMember.isDirty",
  "isSaving"
])], _a14) {
  constructor() {
    ...
    __publicField(this, "phoneVisibilitySelect", __runInitializers(_init14, 24, this)), __runInitializers(_init14, 27, this);
    __privateAdd(this, _member, __runInitializers(_init14, 8, this, null)), __runInitializers(_init14, 11, this);
    __privateAdd(this, _draftMember, __runInitializers(_init14, 12, this, null)), __runInitializers(_init14, 15, this);
    __privateAdd(this, _isSaving, __runInitializers(_init14, 16, this, false)), __runInitializers(_init14, 19, this);
    __privateAdd(this, _saveError, __runInitializers(_init14, 20, this, "")), __runInitializers(_init14, 23, this);
  }
  get profileActionsDisabled() {
...
_member = new WeakMap();
_draftMember = new WeakMap();
_isSaving = new WeakMap();
_saveError = new WeakMap();
__decorateElement(_init14, 4, "member", _member_dec, MeProfileApp, _member);
__decorateElement(_init14, 4, "draftMember", _draftMember_dec, MeProfileApp, _draftMember);
__decorateElement(_init14, 4, "isSaving", _isSaving_dec, MeProfileApp, _isSaving);
__decorateElement(_init14, 4, "saveError", _saveError_dec, MeProfileApp, _saveError);
__decorateElement(_init14, 2, "profileActionsDisabled", _profileActionsDisabled_dec, MeProfileApp);
__decorateElement(_init14, 5, "phoneVisibilitySelect", _phoneVisibilitySelect_dec, MeProfileApp);
MeProfileApp = __decorateElement(_init14, 0, "MeProfileApp", _MeProfileApp_decorators, MeProfileApp);
__runInitializers(_init14, 1, MeProfileApp);
var _isSearching_dec, _candidates_dec, _query_dec, _results_dec, _a15, _MemberPicker_decorators, _init15, _query, _candidates, _isSearching;
_MemberPicker_decorators = [register];
var MemberPicker = class extends (_a15 = Controller, _results_dec = [outlet], _query_dec = [observable], _candidates_dec = [observable], _isSearching_dec = [observable], _a15) {
  constructor() {
    super(...arguments);
    __publicField(this, "results", __runInitializers(_init15, 20, this)), __runInitializers(_init15, 23, this);
    __privateAdd(this, _query, __runInitializers(_init15, 8, this, "")), __runInitializers(_init15, 11, this);
    __privateAdd(this, _candidates, __runInitializers(_init15, 12, this, [])), __runInitializers(_init15, 15, this);
    __privateAdd(this, _isSearching, __runInitializers(_init15, 16, this, false)), __runInitializers(_init15, 19, this);
    __publicField(this, "searchTimer", null);
    __publicField(this, "searchGeneration", 0);
  }
  get parent() {
    return super.parent;
  }
...
_isSearching = new WeakMap();
__decorateElement(_init15, 4, "query", _query_dec, MemberPicker, _query);
__decorateElement(_init15, 4, "candidates", _candidates_dec, MemberPicker, _candidates);
__decorateElement(_init15, 4, "isSearching", _isSearching_dec, MemberPicker, _isSearching);
__decorateElement(_init15, 5, "results", _results_dec, MemberPicker);
MemberPicker = __decorateElement(_init15, 0, "MemberPicker", _MemberPicker_decorators, MemberPicker);
__runInitializers(_init15, 1, MemberPicker);
var _selectedObjectId_dec, _a16, _MailingListSourceList_decorators, _init16, _selectedObjectId;
_MailingListSourceList_decorators = [register];
var MailingListSourceList = class extends (_a16 = List, _selectedObjectId_dec = [binding(selectedObjectIdBinding())], _a16) {
  constructor() {
    super(...arguments);
    __privateAdd(this, _selectedObjectId, __runInitializers(_init16, 8, this, null)), __runInitializers(_init16, 11, this);
  }
};
...
var _lists_dec, _sourceList_dec, _a18, _MailingListsApp_decorators, _init18, _lists;
_MailingListsApp_decorators = [register];
var MailingListsApp = class extends (_a18 = Controller, _sourceList_dec = [outlet], _lists_dec = [observable], _a18) {
  constructor() {
    super(...arguments);
    __publicField(this, "sourceList", __runInitializers(_init18, 12, this)), __runInitializers(_init18, 15, this);
    __privateAdd(this, _lists, __runInitializers(_init18, 8, this, [])), __runInitializers(_init18, 11, this);
  }
  awakeFromDOM() {
    void this.loadLists();
  }
...
_lists = new WeakMap();
__decorateElement(_init18, 4, "lists", _lists_dec, MailingListsApp, _lists);
__decorateElement(_init18, 5, "sourceList", _sourceList_dec, MailingListsApp);
MailingListsApp = __decorateElement(_init18, 0, "MailingListsApp", _MailingListsApp_decorators, MailingListsApp);
__runInitializers(_init18, 1, MailingListsApp);

// examples/giraffic/giraffic.ts
config.baseUrl = "/giraffic-api";
document.addEventListener("DOMContentLoaded", () => {
  Application.shared.start(document.body);
});
//# sourceMappingURL=giraffic.js.map
