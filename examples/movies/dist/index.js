...
var InlineEditor = class extends Editor {
  get parent() {
    return super.parent;
  }
  insertNewline(_event) {
  ...
  controlShouldResignFirstResponder(_control, next) {
  ...
  shouldAllowResignTo(next) {
    const nextEl = next instanceof Controller ? next.view.element : next instanceof View ? next.element : null;
    if (nextEl && this.view.element.contains(nextEl)) return true;
    const host = super.parent;
    if (!host) return true;
...
// examples/movies/controllers/main_view.ts
var _movieList_dec, _typeahead_dec, _statusField_dec, _a9, _MainView_decorators, _init9;
_MainView_decorators = [register];
var MainView = class extends (_a9 = Controller, _statusField_dec = [outlet], _typeahead_dec = [outlet], _movieList_dec = [outlet], _a9) {
  constructor() {
    super(...arguments);
    __publicField(this, "statusField", __runInitializers(_init9, 8, this)), __runInitializers(_init9, 11, this);
    __publicField(this, "typeahead", __runInitializers(_init9, 12, this)), __runInitializers(_init9, 15, this);
    __publicField(this, "movieList", __runInitializers(_init9, 16, this)), __runInitializers(_init9, 19, this);
  }
  awakeFromDOM() {
    makeFirstResponder(this.typeahead);
    this.statusField.message = "type to filter; \u2193/\u2191 to walk; \u23CE on a row; \u241B to return";
  }
};
_init9 = __decoratorStart(_a9);
__decorateElement(_init9, 5, "statusField", _statusField_dec, MainView);
__decorateElement(_init9, 5, "typeahead", _typeahead_dec, MainView);
__decorateElement(_init9, 5, "movieList", _movieList_dec, MainView);
MainView = __decorateElement(_init9, 0, "MainView", _MainView_decorators, MainView);
__runInitializers(_init9, 1, MainView);

// examples/movies/controllers/menubar.ts
var _Menubar_decorators, _init10, _a10;
_Menubar_decorators = [register];
var Menubar = class extends (_a10 = Controller) {
  newMovie() {
...
Menubar = __decorateElement(_init10, 0, "Menubar", _Menubar_decorators, Menubar);
__runInitializers(_init10, 1, Menubar);

// examples/movies/models/movie.ts
var PRIORITY_OPTIONS = ["high", "medium", "someday", "no_interest"];
var VERDICT_OPTIONS = ["favorite", "liked", "mixed", "dislike"];
var _watched_at_dec, _watched_dec, _verdict_dec, _priority_dec, _genre_dec, _director_dec, _year_dec, _title_dec, _a11, _Movie_decorators, _init11, _title, _year, _director, _genre, _priority, _verdict, _watched, _watched_at;
_Movie_decorators = [register];
var Movie = class extends (_a11 = Model, _title_dec = [attr], _year_dec = [attr], _director_dec = [attr], _genre_dec = [attr], _priority_dec = [attr], _verdict_dec = [attr], _watched_dec = [attr], _watched_at_dec = [attr], _a11) {
  constructor() {
    super(...arguments);
    __privateAdd(this, _title, __runInitializers(_init11, 8, this, "")), __runInitializers(_init11, 11, this);
    __privateAdd(this, _year, __runInitializers(_init11, 12, this, null)), __runInitializers(_init11, 15, this);
    __privateAdd(this, _director, __runInitializers(_init11, 16, this, null)), __runInitializers(_init11, 19, this);
    __privateAdd(this, _genre, __runInitializers(_init11, 20, this, null)), __runInitializers(_init11, 23, this);
    __privateAdd(this, _priority, __runInitializers(_init11, 24, this, null)), __runInitializers(_init11, 27, this);
    __privateAdd(this, _verdict, __runInitializers(_init11, 28, this, null)), __runInitializers(_init11, 31, this);
    __privateAdd(this, _watched, __runInitializers(_init11, 32, this, false)), __runInitializers(_init11, 35, this);
    __privateAdd(this, _watched_at, __runInitializers(_init11, 36, this, null)), __runInitializers(_init11, 39, this);
  }
  // YYYY-MM-DD or null
};
...
_title = new WeakMap();
_year = new WeakMap();
_director = new WeakMap();
_genre = new WeakMap();
_priority = new WeakMap();
_verdict = new WeakMap();
_watched = new WeakMap();
_watched_at = new WeakMap();
__decorateElement(_init11, 4, "title", _title_dec, Movie, _title);
__decorateElement(_init11, 4, "year", _year_dec, Movie, _year);
__decorateElement(_init11, 4, "director", _director_dec, Movie, _director);
__decorateElement(_init11, 4, "genre", _genre_dec, Movie, _genre);
__decorateElement(_init11, 4, "priority", _priority_dec, Movie, _priority);
__decorateElement(_init11, 4, "verdict", _verdict_dec, Movie, _verdict);
__decorateElement(_init11, 4, "watched", _watched_dec, Movie, _watched);
__decorateElement(_init11, 4, "watched_at", _watched_at_dec, Movie, _watched_at);
Movie = __decorateElement(_init11, 0, "Movie", _Movie_decorators, Movie);
__publicField(Movie, "url", "/api/movies");
__publicField(Movie, "type", "movie");
__runInitializers(_init11, 1, Movie);
registerTransformer("yesno", {
  parse: (s) => s === "yes",
  format: (v) => v ? "\u2713" : ""
});

// examples/movies/controllers/movie_editor.ts
var _verdictSelect_dec, _prioritySelect_dec, _a12, _MovieEditor_decorators, _init12;
_MovieEditor_decorators = [register];
var MovieEditor = class extends (_a12 = InlineEditor, _prioritySelect_dec = [outlet], _verdictSelect_dec = [outlet], _a12) {
  constructor() {
    super(...arguments);
    __publicField(this, "prioritySelect", __runInitializers(_init12, 8, this)), __runInitializers(_init12, 11, this);
    __publicField(this, "verdictSelect", __runInitializers(_init12, 12, this)), __runInitializers(_init12, 15, this);
  }
  awakeFromDOM() {
...
__decorateElement(_init12, 5, "prioritySelect", _prioritySelect_dec, MovieEditor);
__decorateElement(_init12, 5, "verdictSelect", _verdictSelect_dec, MovieEditor);
MovieEditor = __decorateElement(_init12, 0, "MovieEditor", _MovieEditor_decorators, MovieEditor);
__runInitializers(_init12, 1, MovieEditor);

// examples/movies/controllers/movie_list.ts
var _MovieList_decorators, _init13, _a13;
_MovieList_decorators = [register];
var MovieList = class extends (_a13 = EditableList) {
  get parent() {
    return super.parent;
  }
  ...
  configureRow(el2, m) {
    const pri = el2.querySelector('[bind="priority"]');
    if (pri) pri.dataset.priority = m.priority ?? "";
    const ver = el2.querySelector('[bind="verdict"]');
    if (ver) ver.dataset.verdict = m.verdict ?? "";
  }
  queryGen = 0;
  unobserveMovieCreated = null;
  awakeFromDOM() {
    super.awakeFromDOM();
  ...
  async lookupOmdb(q) {
    ...
    try {
      const url = `${config.baseUrl}/api/movies/omdb?q=${encodeURIComponent(q)}`;
      ...
      const lookupStatus = doc.meta?.lookup_status;
...
MovieList = __decorateElement(_init13, 0, "MovieList", _MovieList_decorators, MovieList);
__runInitializers(_init13, 1, MovieList);

// examples/movies/controllers/new_movie_form.ts
var _directorInput_dec, _yearInput_dec, _titleInput_dec, _a14, _NewMovieForm_decorators, _init14;
_NewMovieForm_decorators = [register];
var NewMovieForm = class extends (_a14 = Controller, _titleInput_dec = [outlet], _yearInput_dec = [outlet], _directorInput_dec = [outlet], _a14) {
  constructor() {
    super(...arguments);
    __publicField(this, "titleInput", __runInitializers(_init14, 8, this)), __runInitializers(_init14, 11, this);
    __publicField(this, "yearInput", __runInitializers(_init14, 12, this)), __runInitializers(_init14, 15, this);
    __publicField(this, "directorInput", __runInitializers(_init14, 16, this)), __runInitializers(_init14, 19, this);
  }
  async save() {
...
__decorateElement(_init14, 5, "titleInput", _titleInput_dec, NewMovieForm);
__decorateElement(_init14, 5, "yearInput", _yearInput_dec, NewMovieForm);
__decorateElement(_init14, 5, "directorInput", _directorInput_dec, NewMovieForm);
NewMovieForm = __decorateElement(_init14, 0, "NewMovieForm", _NewMovieForm_decorators, NewMovieForm);
__runInitializers(_init14, 1, NewMovieForm);

// examples/movies/controllers/status_field.ts
var _message_dec, _a15, _StatusField_decorators, _init15, _message;
_StatusField_decorators = [register];
var StatusField = class extends (_a15 = Controller, _message_dec = [observable], _a15) {
  constructor() {
    super(...arguments);
    __privateAdd(this, _message, __runInitializers(_init15, 8, this, "")), __runInitializers(_init15, 11, this);
  }
};
_init15 = __decoratorStart(_a15);
_message = new WeakMap();
__decorateElement(_init15, 4, "message", _message_dec, StatusField, _message);
StatusField = __decorateElement(_init15, 0, "StatusField", _StatusField_decorators, StatusField);
__runInitializers(_init15, 1, StatusField);

// examples/movies/controllers/typeahead.ts
var _Typeahead_decorators, _init16, _a16;
_Typeahead_decorators = [register];
var Typeahead = class extends (_a16 = TextField) {
...
Typeahead = __decorateElement(_init16, 0, "Typeahead", _Typeahead_decorators, Typeahead);
__runInitializers(_init16, 1, Typeahead);

// examples/movies/index.ts
config.baseUrl = "http://arb-mini.arbales.net:9292";
document.addEventListener("DOMContentLoaded", () => {
  Application.shared.start(document.body);
  const listEl = document.querySelector('[controller="MovieList"]');
  const list = listEl ? controllerFor(listEl) : null;
  list?.applyQuery("");
});
